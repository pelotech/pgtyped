 ...
 *
 * The naming rule itself lives in the runtime, which applies it to a
 * `sql.prepared` tag too: one implementation so both front-ends cannot drift.
 * All that is left here is the config gate.
 *
