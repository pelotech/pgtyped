...
:::note
If you are having trouble configuring PgTyped, you can refer to the [example app](https://github.com/pelotech/pgtyped/tree/HEAD/packages/example) for a preconfigured example.  
:::
